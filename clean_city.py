#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Cleans table `city` from MySQL dump -> city_full.csv
# Input dump (expected): /mnt/data/world.sql.txt
# Output: /mnt/data/city_full.csv
# Error log (if parsing field-count mismatch): /mnt/data/city_full.err
