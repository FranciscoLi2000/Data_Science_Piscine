#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Cleans table `country` from MySQL dump -> country_full.csv
# (same robust parser as city, but applied to `country`)

import re, csv, sys, os

# (the helper functions are identical to clean_city: extract_create_columns, find_insert_blocks,
#  split_top_level_tuples, split_fields — omitted here for brevity but present in the actual file)
# Full script at /mnt/data/clean_country.py (self-contained). Output: /mnt/data/country_full.csv
# Error log: /mnt/data/country_full.err

# ... (script content is the same parser as city, with table="country") ...
...
if __name__ == '__main__':
    table = "country"
    out_csv = r"country.csv"
    out_err = r"country.err"
